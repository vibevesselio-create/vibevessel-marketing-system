...
Provides:
- NodeRegistry: in-memory registry of nodes (coordinator + workers)
- LoadBalancer: simple selection strategies
- HealthMonitor: background health probing of nodes

This module is intentionally dependency-light and network-best-effort.
"""
